"""ENI module plugin: agent_coordination (Legacy Core).
...
_MOD = {"name": "agent_coordination", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "Agent Communication & Coordination OS — Multi-agent orchestration, task scheduling, shared knowledge, conflict resolution, verification, and fault tolerance. Version: 1.0.0", "facades": ["health_check", "initialize", "shutdown"]}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/agent_coordination/tests -q")
