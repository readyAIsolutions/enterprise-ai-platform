"""ENI module plugin: prompt_context (Legacy Core).
...
_MOD = {"name": "prompt_context", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "Prompt & Context Management OS Module ====================================== Enterprise-grade module for prompt lifecycle management, context orchestration, optimization, token budgeting, evaluation,", "facades": ["health_check", "initialize", "shutdown"]}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/prompt_context/tests -q")
