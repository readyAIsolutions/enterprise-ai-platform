"""ENI module plugin: threat_model (Legacy Core).
...
_MOD = {"name": "threat_model", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "ENI Threat Model OS Module. Offline MITRE ATLAS / STRIDE threat modeling and attack-surface analysis for LLM systems. Provides a curated catalogue of MITRE ATLAS threats, a threat library with catego", "facades": []}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/threat_model/tests -q")
