"""ENI module plugin: knowledge_graph (Legacy Core).
...
_MOD = {"name": "knowledge_graph", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "Knowledge Graph OS Module Enterprise-grade knowledge graph for mapping and managing organizational knowledge: entities, relationships, provenance, resolution, contradiction management, and secure ret", "facades": ["health_check", "initialize", "shutdown"]}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/knowledge_graph/tests -q")
