"""ENI module plugin: ai_defense (Legacy Core).
...
_MOD = {"name": "ai_defense", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "ENI Enterprise AI Defense OS Module. Defense against *AI-driven / automated* attackers: statistical anomaly detection, bot/agent traffic classification, model-extraction probing shield, credential- s", "facades": []}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/ai_defense/tests -q")
