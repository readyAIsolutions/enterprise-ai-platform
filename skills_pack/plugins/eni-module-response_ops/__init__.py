"""ENI module plugin: response_ops (Legacy Core).
...
_MOD = {"name": "response_ops", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "ENI Response Ops Module — self-healing fleet supervisor + ICM routing hook. Public surface: * :class:`FleetSupervisor` / :func:`create_fleet_supervisor` — the self-healing supervisor that prob", "facades": []}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/response_ops/tests -q")
