"""ENI module plugin: disaster_recovery (Legacy Core).
...
_MOD = {"name": "disaster_recovery", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "Disaster Recovery OS Module Enterprise-grade disaster recovery, business continuity, and crisis management. Covers backup, recovery, cyber recovery, AI continuity, exercises, and crisis coordination.", "facades": ["health_check", "initialize", "shutdown"]}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/disaster_recovery/tests -q")
