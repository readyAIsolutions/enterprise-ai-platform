"""ENI module plugin: rag (Legacy Core).
...
_MOD = {"name": "rag", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "Production RAG System — Enterprise-grade Retrieval-Augmented Generation. This module provides a complete, production-ready RAG system with: 1. Chunking Strategies (Semantic + Fixed) 2. Embedding Mode", "facades": []}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/rag/tests -q")
