"""ENI module plugin: safety_governance (Legacy Core).
...
_MOD = {"name": "safety_governance", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "ENI Enterprise — Safety & Governance OS v1.0.0 AI Safety, Security, Guardrails, Evaluation, Monitoring, Incident Response.", "facades": ["health_check", "initialize", "shutdown"]}


def _on_transform_tool_result(result, **_):
    try:
        tag = "safety_governance"
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/safety_governance/tests -q")
