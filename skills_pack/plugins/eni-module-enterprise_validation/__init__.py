"""ENI module plugin: enterprise_validation (Legacy Core).
...
_MOD = {"name": "enterprise_validation", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "Enterprise Validation & Certification OS — Module Entry Point ============================================================== @module(name='enterprise_validation', version='1.0.0')", "facades": ["engine", "health_check", "initialize", "shutdown", "validate_all", "validate_module"]}


def _on_transform_tool_result(result, **_):
    try:
        tag = "enterprise_validation"
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/enterprise_validation/tests -q")
