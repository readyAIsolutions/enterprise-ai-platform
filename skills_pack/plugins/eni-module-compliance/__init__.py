"""ENI module plugin: compliance (Legacy Core).
...
_MOD = {"name": "compliance", "category": "Legacy Core", "version": "1.1.0",
        "purpose": "ENI Enterprise Compliance OS Module. Offline security-control mapping & audit evidence for the ENI platform across: * OWASP LLM Top 10 (2025) * NIST AI RMF 1.0 core functions (GOVERN / MAP / MEASURE", "facades": []}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/compliance/tests -q")
