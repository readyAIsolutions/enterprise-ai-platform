"""ENI module plugin: universal_score (Legacy Core).
...
_MOD = {"name": "universal_score", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "ENI Universal Build Score module. One accurate, industry-grounded build-quality number that tests any real software build on disk and certifies it. 100 = fully sellable enterprise; a excellence bonus", "facades": []}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/universal_score/tests -q")
