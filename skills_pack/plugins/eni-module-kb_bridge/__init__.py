"""ENI module plugin: kb_bridge (Legacy Core).
...
_MOD = {"name": "kb_bridge", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "ENI Knowledge Base OS Module Enterprise-grade wrapper around Hermes KB Universal, providing structured CRUD, search, vector search, metrics, and health checks as a registered Platform Kernel module.", "facades": ["bridge", "health_check", "health_checker", "initialize", "set_event_bus", "shutdown"]}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/kb_bridge/tests -q")
