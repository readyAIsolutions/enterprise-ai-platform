"""ENI module plugin: unified_inbox (Legacy Core).
...
_MOD = {"name": "unified_inbox", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "Enterprise Platform Unified Inbox module package. Grounded in the JEVanClief 'Clawdbot (Moltbot) Has 100K Stars. It Has Zero AI.' transcript: a zero-AI universal assistant that consolidates every mes", "facades": ["health_check", "inbox", "initialize", "set_event_bus", "shutdown"]}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/unified_inbox/tests -q")
