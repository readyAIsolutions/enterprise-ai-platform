"""ENI module plugin: swarm_network (Legacy Core).
...
_MOD = {"name": "swarm_network", "category": "Legacy Core", "version": "2.0.0",
        "purpose": "Swarm Network Optimization OS — Enterprise Module ================================================== Enterprise-grade connection multiplexer for maximum agent concurrency. Integrates the Swarm Turboch", "facades": ["bridge", "health_check", "initialize", "shutdown"]}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/swarm_network/tests -q")
