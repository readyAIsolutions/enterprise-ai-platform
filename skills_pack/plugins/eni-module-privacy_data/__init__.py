"""ENI module plugin: privacy_data (Legacy Core).
...
_MOD = {"name": "privacy_data", "category": "Legacy Core", "version": "1.0.0",
        "purpose": "Privacy & Data Governance OS Module ==================================== Enterprise-grade privacy, data governance, security, and compliance module. Modules: classifier - Data classification engin", "facades": ["health_check", "initialize", "shutdown"]}
...
def _on_transform_tool_result(result, **_):
    try:
        ...
        if tag in blob:
            ...
            lines.append("  Tests: python3 -m pytest modules/privacy_data/tests -q")
