"""Kernel lifecycle registration tests for safety_governance.
...
MODULE_NAME = "safety_governance"
MODULE_CLASS = "SafetyGovernanceModule"
FACTORY = "create_safety_governance_module"


def _module():
    return importlib.import_module("enterprise.modules.safety_governance")
