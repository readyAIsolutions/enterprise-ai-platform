"""Kernel lifecycle registration tests for innovation_rd.
...
MODULE_NAME = "innovation_rd"
MODULE_CLASS = "InnovationRDModule"
FACTORY = "create_innovation_rd_module"


def _module():
    return importlib.import_module("enterprise.modules.innovation_rd")
