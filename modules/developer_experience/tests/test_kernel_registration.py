"""Kernel lifecycle registration tests for developer_experience.
...
MODULE_NAME = "developer_experience"
MODULE_CLASS = "DeveloperExperienceModule"
FACTORY = "create_developer_experience_module"


def _module():
    return importlib.import_module("enterprise.modules.developer_experience")
