"""Kernel lifecycle registration tests for prompt_context.
...
MODULE_NAME = "prompt_context"
MODULE_CLASS = "PromptContextModule"
FACTORY = "create_prompt_context_module"


def _module():
    return importlib.import_module("enterprise.modules.prompt_context")
