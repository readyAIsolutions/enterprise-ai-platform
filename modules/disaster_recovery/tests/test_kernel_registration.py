"""Kernel lifecycle registration tests for disaster_recovery.
...
MODULE_CLASS = "DisasterRecoveryModule"
FACTORY = "create_disaster_recovery_module"


def _module():
    return importlib.import_module("enterprise.modules.disaster_recovery")
