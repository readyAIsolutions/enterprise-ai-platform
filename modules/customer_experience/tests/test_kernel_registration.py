"""Kernel lifecycle registration tests for customer_experience.
...
MODULE_NAME = "customer_experience"
MODULE_CLASS = "CustomerExperienceModule"
FACTORY = "create_customer_experience_module"


def _module():
    return importlib.import_module("enterprise.modules.customer_experience")
