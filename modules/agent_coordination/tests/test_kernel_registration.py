"""Kernel lifecycle registration tests for agent_coordination.
...
MODULE_NAME = "agent_coordination"
MODULE_CLASS = "AgentCoordinationModule"
FACTORY = "create_agent_coordination_module"


def _module():
    return importlib.import_module("enterprise.modules.agent_coordination")
