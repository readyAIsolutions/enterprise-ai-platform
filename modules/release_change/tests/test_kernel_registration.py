"""Kernel lifecycle registration tests for release_change.
...
MODULE_NAME = "release_change"
MODULE_CLASS = "ReleaseChangeModule"
FACTORY = "create_release_change_module"


def _module():
    return importlib.import_module("enterprise.modules.release_change")
