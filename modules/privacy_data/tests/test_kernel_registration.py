"""Kernel lifecycle registration tests for privacy_data.
...
MODULE_NAME = "privacy_data"
MODULE_CLASS = "PrivacyDataModule"
FACTORY = "create_privacy_data_module"


def _module():
    return importlib.import_module("enterprise.modules.privacy_data")
